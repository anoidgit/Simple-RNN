...
local aFastLSTM, parent = torch.class('nn.aFastLSTM', 'nn.aBstractSeq')
...
--[[function aFastLSTM:_asign(seqd)
...
function aFastLSTM:_prepare_data(input)
...
-- apply value copied
function aFastLSTM:_Copy(data, isForwardCopy)
...
function aFastLSTM:_step_updateOutput(input)
...
function aFastLSTM:_tseq_updateOutput(input)
...
function aFastLSTM:_seq_updateOutput(input)
...
--[[function aFastLSTM:_check_table_same(tbin)
...
function aFastLSTM:_step_backward(input, gradOutput, scale)
	...
	local _cPrevOutput, _cPrevCell, _cotanh, _coogate, _coz, _coifogate, _coigate, _cofgate
...
function aFastLSTM:_seq_backward(input, gradOutput, scale)
...
function aFastLSTM:_tseq_backward(input, gradOutput, scale)
...
-- updateParameters 
--[[function aFastLSTM:updateParameters(learningRate)
...
-- zeroGradParameters
--[[function aFastLSTM:zeroGradParameters()
...
-- accGradParameters used for aFastLSTM.bias
function aFastLSTM:_accGradParameters(scale)
...
function aFastLSTM:_tensor_clearState(tsr)
	...
	-- just point self.outputs to keep aFastLSTM standard
...
-- clear the storage
function aFastLSTM:_table_clearState()
...
function aFastLSTM:reset(stdv)
	...
	self.modules = {self.ifogate, self.zmod, self.sbm, self.tanh}
...
--[[function aFastLSTM:buildIFModule()
...
function aFastLSTM:buildUpdateModule()
...
-- build a module that contains aFastLSTM.bias and aFastLSTM.gradBias to make it fit Container
function aFastLSTM:buildSelfBias(outputSize)
...
-- introduce self
function aFastLSTM:__tostring__()
