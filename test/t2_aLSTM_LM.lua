...
cmd:option('--saturate', 256, 'epoch at which linear decayed LR will reach minlr')
...
cmd:option('--inputsize', 128, 'size of lookup table embeddings. -1 defaults to hiddensize[1]')
...
cmd:option('--id', '20161129', 'id string of this experiment (used to name output file) (defaults to a unique id)')
...
require 'aLSTM'
rnn = nn.aLSTM(inputsize, opt.hiddensize, true)
